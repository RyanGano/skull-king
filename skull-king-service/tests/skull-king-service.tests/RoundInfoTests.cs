...
public class RoundInfoTests
{
  ...
  public void CanCreateRoundInfo()
  {
    ...
    var roundInfo = RoundInfo.Create(players, 1);
  ...
  public void CanEditRoundInfo()
  {
    ...
    var updatedPlayerRound = PlayerRound.Create(playerOneRound!.Player!, playerOneRound.Round!.WithBid(1));

    var newRoundInfo = RoundInfo.Create(roundInfo, updatedPlayerRound);
